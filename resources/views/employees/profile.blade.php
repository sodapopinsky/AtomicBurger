...
@section('content')
    ...
    <section id="content">
        <div class="container">
            ...
            <a style="display:none;" id="target" data-toggle="modal" href="#modalDefault"
               class="btn btn-sm btn-default">Modal - Small</a>
                        ...
                        <form action="/insert/writeup" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <div class="fg-line">
                                        <textarea name="writeUp" class="form-control" rows="5"
                                                  placeholder="What'd they do this time?"></textarea>
                                    </div>
                                </div>
                        ...
                        @foreach($writeUps as $item)
                            ...
                            <div class="lv-item media">
                                ...
                                <div class="media-body">
                                    ...
                                    <ul class="lv-attrs">
                                        <li>{{{Carbon::instance($item->created_at)->diffForHumans()}}}</li>
                                    ...
                                    <div class="lv-actions actions dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right ">
                                            <form method="post" action="/delete/writeup/{{{$item->id}}}">
